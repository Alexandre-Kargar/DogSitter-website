...
<div class="Connexion_form">
  <p style="color:orange" class="Title">Annonce de: <?php echo $user["fname"]; ?> <?php echo $user["lname"]; ?></p>

  </p>

  <Div  action="updateInformations.php" method="POST">
...
<?php else: ?>
    ...
    <p class="subtitle" style="font-size:20px">Vous devez être connecté à votre compte DogSitter pour consulter les détails de l'annonce.</br></br></br>

  <a href="login.php" style="color:blue">Connectez-vous à votre compte</a> ou <a href="inscription.html" style="color:blue">Créer un compte</p>
</div>
  <?php endif; ?>
